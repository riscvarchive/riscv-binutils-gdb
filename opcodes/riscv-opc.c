...
{"andn",      0, INSN_CLASS_B,   "d,s,t",  MATCH_ANDN, MASK_ANDN, match_opcode, 0 },
{"orn",       0, INSN_CLASS_B,   "d,s,t",  MATCH_ORN, MASK_ORN, match_opcode, 0 },
{"xnor",      0, INSN_CLASS_B,   "d,s,t",  MATCH_XNOR, MASK_XNOR, match_opcode, 0 },
{"sloi",      0, INSN_CLASS_B,   "d,s,>",  MATCH_SLOI, MASK_SLOI, match_opcode, 0 },
{"sroi",      0, INSN_CLASS_B,   "d,s,>",  MATCH_SROI, MASK_SROI, match_opcode, 0 },
{"roli",      0, INSN_CLASS_B,   "d,s,>",  0, (int) M_RL, match_never, INSN_MACRO },
{"rori",      0, INSN_CLASS_B,   "d,s,>",  MATCH_RORI, MASK_RORI, match_opcode, 0 },
...
{"rol",       0, INSN_CLASS_B,   "d,s,t",  MATCH_ROL, MASK_ROL, match_opcode, 0 },
{"rol",       0, INSN_CLASS_B,   "d,s,>",  0, (int) M_RL, match_never, INSN_MACRO },
{"ror",       0, INSN_CLASS_B,   "d,s,t",  MATCH_ROR, MASK_ROR, match_opcode, 0 },
{"ror",       0, INSN_CLASS_B,   "d,s,>",  MATCH_RORI, MASK_RORI, match_opcode, INSN_ALIAS },
{"sbclri",    0, INSN_CLASS_B,   "d,s,>",  MATCH_SBCLRI, MASK_SBCLRI, match_opcode, 0 },
{"sbseti",    0, INSN_CLASS_B,   "d,s,>",  MATCH_SBSETI, MASK_SBSETI, match_opcode, 0 },
{"sbinvi",    0, INSN_CLASS_B,   "d,s,>",  MATCH_SBINVI, MASK_SBINVI, match_opcode, 0 },
{"sbexti",    0, INSN_CLASS_B,   "d,s,>",  MATCH_SBEXTI, MASK_SBEXTI, match_opcode, 0 },
...
{"sbclr",     0, INSN_CLASS_B,   "d,s,t",  MATCH_SBCLR, MASK_SBCLR, match_opcode, 0 },
{"sbclr",     0, INSN_CLASS_B,   "d,s,>",  MATCH_SBCLRI, MASK_SBCLRI, match_opcode, INSN_ALIAS },
{"sbset",     0, INSN_CLASS_B,   "d,s,t",  MATCH_SBSET, MASK_SBSET, match_opcode, 0 },
{"sbset",     0, INSN_CLASS_B,   "d,s,>",  MATCH_SBSETI, MASK_SBSETI, match_opcode, INSN_ALIAS },
{"sbinv",     0, INSN_CLASS_B,   "d,s,t",  MATCH_SBINV, MASK_SBINV, match_opcode, 0 },
{"sbinv",     0, INSN_CLASS_B,   "d,s,>",  MATCH_SBINVI, MASK_SBINVI, match_opcode, INSN_ALIAS },
{"sbext",     0, INSN_CLASS_B,   "d,s,t",  MATCH_SBEXT, MASK_SBEXT, match_opcode, 0 },
{"sbext",     0, INSN_CLASS_B,   "d,s,>",  MATCH_SBEXTI, MASK_SBEXTI, match_opcode, INSN_ALIAS },
...
{"fsli",      0, INSN_CLASS_B,   "d,s,r,>",  0, (int) M_FL, match_never, INSN_MACRO },
...
{"fsl",       0, INSN_CLASS_B,   "d,s,r,>",  0, (int) M_FL, match_never, INSN_MACRO },
...
{"clz",       0, INSN_CLASS_B,   "d,s",  MATCH_CLZ, MASK_CLZ, match_opcode, 0 },
{"ctz",       0, INSN_CLASS_B,   "d,s",  MATCH_CTZ, MASK_CTZ, match_opcode, 0 },
{"pcnt",      0, INSN_CLASS_B,   "d,s",  MATCH_PCNT, MASK_PCNT, match_opcode, 0 },
...
{"clmul",     0, INSN_CLASS_B,   "d,s,t",  MATCH_CLMUL, MASK_CLMUL, match_opcode, 0 },
{"clmulh",    0, INSN_CLASS_B,   "d,s,t",  MATCH_CLMULH, MASK_CLMULH, match_opcode, 0 },
{"clmulr",    0, INSN_CLASS_B,   "d,s,t",  MATCH_CLMULR, MASK_CLMULR, match_opcode, 0 },
{"min",       0, INSN_CLASS_B,   "d,s,t",  MATCH_MIN, MASK_MIN, match_opcode, 0 },
{"max",       0, INSN_CLASS_B,   "d,s,t",  MATCH_MAX, MASK_MAX, match_opcode, 0 },
{"minu",      0, INSN_CLASS_B,   "d,s,t",  MATCH_MINU, MASK_MINU, match_opcode, 0 },
{"maxu",      0, INSN_CLASS_B,   "d,s,t",  MATCH_MAXU, MASK_MAXU, match_opcode, 0 },
...
{"addiwu",   64, INSN_CLASS_B,   "d,s,j",  MATCH_ADDIWU, MASK_ADDIWU, match_opcode, 0 },
{"slliu.w",  64, INSN_CLASS_B,   "d,s,>",  MATCH_SLLIU_W, MASK_SLLIU_W, match_opcode, 0 },
{"addwu",    64, INSN_CLASS_B,   "d,s,t",  MATCH_ADDWU, MASK_ADDWU, match_opcode, 0 },
{"subwu",    64, INSN_CLASS_B,   "d,s,t",  MATCH_SUBWU, MASK_SUBWU, match_opcode, 0 },
{"addu.w",   64, INSN_CLASS_B,   "d,s,t",  MATCH_ADDU_W, MASK_ADDU_W, match_opcode, 0 },
...
{"roliw",    64, INSN_CLASS_B,   "d,s,<",  0, (int) M_RL, match_never, INSN_MACRO },
{"roriw",    64, INSN_CLASS_B,   "d,s,<",  MATCH_RORIW, MASK_RORIW, match_opcode, 0 },
...
{"rolw",     64, INSN_CLASS_B,   "d,s,t",  MATCH_ROLW, MASK_ROLW, match_opcode, 0 },
{"rolw",     64, INSN_CLASS_B,   "d,s,<",  0, (int) M_RL, match_never, INSN_MACRO },
{"rorw",     64, INSN_CLASS_B,   "d,s,t",  MATCH_RORW, MASK_RORW, match_opcode, 0 },
{"rorw",     64, INSN_CLASS_B,   "d,s,<",  MATCH_RORIW, MASK_RORIW, match_opcode, INSN_ALIAS },
{"sbclriw",  64, INSN_CLASS_B,   "d,s,<",  MATCH_SBCLRIW, MASK_SBCLRIW, match_opcode, 0 },
{"sbsetiw",  64, INSN_CLASS_B,   "d,s,<",  MATCH_SBSETIW, MASK_SBSETIW, match_opcode, 0 },
{"sbinviw",  64, INSN_CLASS_B,   "d,s,<",  MATCH_SBINVIW, MASK_SBINVIW, match_opcode, 0 },
...
{"sbclrw",   64, INSN_CLASS_B,   "d,s,t",  MATCH_SBCLRW, MASK_SBCLRW, match_opcode, 0 },
{"sbclrw",   64, INSN_CLASS_B,   "d,s,<",  MATCH_SBCLRIW, MASK_SBCLRIW, match_opcode, INSN_ALIAS },
{"sbsetw",   64, INSN_CLASS_B,   "d,s,t",  MATCH_SBSETW, MASK_SBSETW, match_opcode, 0 },
{"sbsetw",   64, INSN_CLASS_B,   "d,s,<",  MATCH_SBSETIW, MASK_SBSETIW, match_opcode, INSN_ALIAS },
{"sbinvw",   64, INSN_CLASS_B,   "d,s,t",  MATCH_SBINVW, MASK_SBINVW, match_opcode, 0 },
{"sbinvw",   64, INSN_CLASS_B,   "d,s,<",  MATCH_SBINVIW, MASK_SBINVIW, match_opcode, INSN_ALIAS },
{"sbextw",   64, INSN_CLASS_B,   "d,s,t",  MATCH_SBEXTW, MASK_SBEXTW, match_opcode, 0 },
...
{"fsliw",    64, INSN_CLASS_B,   "d,s,r,<",  0, (int) M_FL, match_never, INSN_MACRO },
...
{"fslw",     64, INSN_CLASS_B,   "d,s,r,<",  0, (int) M_FL, match_never, INSN_MACRO },
...
{"clzw",     64, INSN_CLASS_B,   "d,s",  MATCH_CLZW, MASK_CLZW, match_opcode, 0 },
{"ctzw",     64, INSN_CLASS_B,   "d,s",  MATCH_CTZW, MASK_CTZW, match_opcode, 0 },
{"pcntw",    64, INSN_CLASS_B,   "d,s",  MATCH_PCNTW, MASK_PCNTW, match_opcode, 0 },
{"clmulw",   64, INSN_CLASS_B,   "d,s,t",  MATCH_CLMULW, MASK_CLMULW, match_opcode, 0 },
{"clmulhw",  64, INSN_CLASS_B,   "d,s,t",  MATCH_CLMULHW, MASK_CLMULHW, match_opcode, 0 },
{"clmulrw",  64, INSN_CLASS_B,   "d,s,t",  MATCH_CLMULRW, MASK_CLMULRW, match_opcode, 0 },
...
{"bdepw",    64, INSN_CLASS_B,   "d,s,t",  MATCH_BDEPW, MASK_BDEP, match_opcode, 0 },
{"bextw",    64, INSN_CLASS_B,   "d,s,t",  MATCH_BEXTW, MASK_BEXT, match_opcode, 0 },
{"packw",    64, INSN_CLASS_B,   "d,s,t",  MATCH_PACKW, MASK_PACK, match_opcode, 0 },
{"bfpw",     64, INSN_CLASS_B,   "d,s,t",  MATCH_BFPW, MASK_BFP, match_opcode, 0 },
...
{"rev8",      0, INSN_CLASS_B,   "d,s",  0, (int) M_PERM, match_never, INSN_MACRO },
...
{"orc.b",     0, INSN_CLASS_B,   "d,s",  0, (int) M_PERM, match_never, INSN_MACRO },
