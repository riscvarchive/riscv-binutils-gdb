...
{"vlxseg2b.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG2BV, MASK_VLXSEG2BV, match_opcode, INSN_DREF },
{"vlxseg2h.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG2HV, MASK_VLXSEG2HV, match_opcode, INSN_DREF },
{"vlxseg2w.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG2WV, MASK_VLXSEG2WV, match_opcode, INSN_DREF },
{"vlxseg2bu.v", 0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG2BUV, MASK_VLXSEG2BUV, match_opcode, INSN_DREF },
{"vlxseg2hu.v", 0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG2HUV, MASK_VLXSEG2HUV, match_opcode, INSN_DREF },
{"vlxseg2wu.v", 0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG2WUV, MASK_VLXSEG2WUV, match_opcode, INSN_DREF },
{"vlxseg2e.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG2EV, MASK_VLXSEG2EV, match_opcode, INSN_DREF },
{"vsxseg2b.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG2BV, MASK_VSXSEG2BV, match_opcode, INSN_DREF },
{"vsxseg2h.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG2HV, MASK_VSXSEG2HV, match_opcode, INSN_DREF },
{"vsxseg2w.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG2WV, MASK_VSXSEG2WV, match_opcode, INSN_DREF },
{"vsxseg2e.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG2EV, MASK_VSXSEG2EV, match_opcode, INSN_DREF },

{"vlxseg3b.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG3BV, MASK_VLXSEG3BV, match_opcode, INSN_DREF },
{"vlxseg3h.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG3HV, MASK_VLXSEG3HV, match_opcode, INSN_DREF },
{"vlxseg3w.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG3WV, MASK_VLXSEG3WV, match_opcode, INSN_DREF },
{"vlxseg3bu.v", 0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG3BUV, MASK_VLXSEG3BUV, match_opcode, INSN_DREF },
{"vlxseg3hu.v", 0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG3HUV, MASK_VLXSEG3HUV, match_opcode, INSN_DREF },
{"vlxseg3wu.v", 0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG3WUV, MASK_VLXSEG3WUV, match_opcode, INSN_DREF },
{"vlxseg3e.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG3EV, MASK_VLXSEG3EV, match_opcode, INSN_DREF },
{"vsxseg3b.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG3BV, MASK_VSXSEG3BV, match_opcode, INSN_DREF },
{"vsxseg3h.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG3HV, MASK_VSXSEG3HV, match_opcode, INSN_DREF },
{"vsxseg3w.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG3WV, MASK_VSXSEG3WV, match_opcode, INSN_DREF },
{"vsxseg3e.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG3EV, MASK_VSXSEG3EV, match_opcode, INSN_DREF },

{"vlxseg4b.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG4BV, MASK_VLXSEG4BV, match_opcode, INSN_DREF },
{"vlxseg4h.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG4HV, MASK_VLXSEG4HV, match_opcode, INSN_DREF },
{"vlxseg4w.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG4WV, MASK_VLXSEG4WV, match_opcode, INSN_DREF },
{"vlxseg4bu.v", 0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG4BUV, MASK_VLXSEG4BUV, match_opcode, INSN_DREF },
{"vlxseg4hu.v", 0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG4HUV, MASK_VLXSEG4HUV, match_opcode, INSN_DREF },
{"vlxseg4wu.v", 0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG4WUV, MASK_VLXSEG4WUV, match_opcode, INSN_DREF },
{"vlxseg4e.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG4EV, MASK_VLXSEG4EV, match_opcode, INSN_DREF },
{"vsxseg4b.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG4BV, MASK_VSXSEG4BV, match_opcode, INSN_DREF },
{"vsxseg4h.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG4HV, MASK_VSXSEG4HV, match_opcode, INSN_DREF },
{"vsxseg4w.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG4WV, MASK_VSXSEG4WV, match_opcode, INSN_DREF },
{"vsxseg4e.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG4EV, MASK_VSXSEG4EV, match_opcode, INSN_DREF },

{"vlxseg5b.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG5BV, MASK_VLXSEG5BV, match_opcode, INSN_DREF },
{"vlxseg5h.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG5HV, MASK_VLXSEG5HV, match_opcode, INSN_DREF },
{"vlxseg5w.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG5WV, MASK_VLXSEG5WV, match_opcode, INSN_DREF },
{"vlxseg5bu.v", 0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG5BUV, MASK_VLXSEG5BUV, match_opcode, INSN_DREF },
{"vlxseg5hu.v", 0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG5HUV, MASK_VLXSEG5HUV, match_opcode, INSN_DREF },
{"vlxseg5wu.v", 0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG5WUV, MASK_VLXSEG5WUV, match_opcode, INSN_DREF },
{"vlxseg5e.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG5EV, MASK_VLXSEG5EV, match_opcode, INSN_DREF },
{"vsxseg5b.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG5BV, MASK_VSXSEG5BV, match_opcode, INSN_DREF },
{"vsxseg5h.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG5HV, MASK_VSXSEG5HV, match_opcode, INSN_DREF },
{"vsxseg5w.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG5WV, MASK_VSXSEG5WV, match_opcode, INSN_DREF },
{"vsxseg5e.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG5EV, MASK_VSXSEG5EV, match_opcode, INSN_DREF },

{"vlxseg6b.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG6BV, MASK_VLXSEG6BV, match_opcode, INSN_DREF },
{"vlxseg6h.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG6HV, MASK_VLXSEG6HV, match_opcode, INSN_DREF },
{"vlxseg6w.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG6WV, MASK_VLXSEG6WV, match_opcode, INSN_DREF },
{"vlxseg6bu.v", 0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG6BUV, MASK_VLXSEG6BUV, match_opcode, INSN_DREF },
{"vlxseg6hu.v", 0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG6HUV, MASK_VLXSEG6HUV, match_opcode, INSN_DREF },
{"vlxseg6wu.v", 0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG6WUV, MASK_VLXSEG6WUV, match_opcode, INSN_DREF },
{"vlxseg6e.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG6EV, MASK_VLXSEG6EV, match_opcode, INSN_DREF },
{"vsxseg6b.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG6BV, MASK_VSXSEG6BV, match_opcode, INSN_DREF },
{"vsxseg6h.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG6HV, MASK_VSXSEG6HV, match_opcode, INSN_DREF },
{"vsxseg6w.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG6WV, MASK_VSXSEG6WV, match_opcode, INSN_DREF },
{"vsxseg6e.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG6EV, MASK_VSXSEG6EV, match_opcode, INSN_DREF },

{"vlxseg7b.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG7BV, MASK_VLXSEG7BV, match_opcode, INSN_DREF },
{"vlxseg7h.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG7HV, MASK_VLXSEG7HV, match_opcode, INSN_DREF },
{"vlxseg7w.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG7WV, MASK_VLXSEG7WV, match_opcode, INSN_DREF },
{"vlxseg7bu.v", 0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG7BUV, MASK_VLXSEG7BUV, match_opcode, INSN_DREF },
{"vlxseg7hu.v", 0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG7HUV, MASK_VLXSEG7HUV, match_opcode, INSN_DREF },
{"vlxseg7wu.v", 0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG7WUV, MASK_VLXSEG7WUV, match_opcode, INSN_DREF },
{"vlxseg7e.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG7EV, MASK_VLXSEG7EV, match_opcode, INSN_DREF },
{"vsxseg7b.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG7BV, MASK_VSXSEG7BV, match_opcode, INSN_DREF },
{"vsxseg7h.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG7HV, MASK_VSXSEG7HV, match_opcode, INSN_DREF },
{"vsxseg7w.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG7WV, MASK_VSXSEG7WV, match_opcode, INSN_DREF },
{"vsxseg7e.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG7EV, MASK_VSXSEG7EV, match_opcode, INSN_DREF },

{"vlxseg8b.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG8BV, MASK_VLXSEG8BV, match_opcode, INSN_DREF },
{"vlxseg8h.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG8HV, MASK_VLXSEG8HV, match_opcode, INSN_DREF },
{"vlxseg8w.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG8WV, MASK_VLXSEG8WV, match_opcode, INSN_DREF },
{"vlxseg8bu.v", 0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG8BUV, MASK_VLXSEG8BUV, match_opcode, INSN_DREF },
{"vlxseg8hu.v", 0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG8HUV, MASK_VLXSEG8HUV, match_opcode, INSN_DREF },
{"vlxseg8wu.v", 0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG8WUV, MASK_VLXSEG8WUV, match_opcode, INSN_DREF },
{"vlxseg8e.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VLXSEG8EV, MASK_VLXSEG8EV, match_opcode, INSN_DREF },
{"vsxseg8b.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG8BV, MASK_VSXSEG8BV, match_opcode, INSN_DREF },
{"vsxseg8h.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG8HV, MASK_VSXSEG8HV, match_opcode, INSN_DREF },
{"vsxseg8w.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG8WV, MASK_VSXSEG8WV, match_opcode, INSN_DREF },
{"vsxseg8e.v",  0, INSN_CLASS_V,  "Vd,0(s),tVm", MATCH_VSXSEG8EV, MASK_VSXSEG8EV, match_opcode, INSN_DREF },
...
{"vamoaddw.v",  0, INSN_CLASS_V,  "Ve,Vt,(s),VfVm", MATCH_VAMOADDWV, MASK_VAMOADDWV, match_opcode, INSN_DREF},
{"vamoaddd.v",  0, INSN_CLASS_V,  "Ve,Vt,(s),VfVm", MATCH_VAMOADDDV, MASK_VAMOADDDV, match_opcode, INSN_DREF},
...
{"vadc.vv",    0, INSN_CLASS_V,  "Vd,Vt,Vs", MATCH_VADCVV, MASK_VADCVV, match_opcode, 0 },
{"vadc.vx",    0, INSN_CLASS_V,  "Vd,Vt,s", MATCH_VADCVX, MASK_VADCVX, match_opcode, 0 },
{"vadc.vi",    0, INSN_CLASS_V,  "Vd,Vt,Vi", MATCH_VADCVI, MASK_VADCVI, match_opcode, 0 },
{"vsbc.vv",    0, INSN_CLASS_V,  "Vd,Vt,Vs", MATCH_VSBCVV, MASK_VSBCVV, match_opcode, 0 },
{"vsbc.vx",    0, INSN_CLASS_V,  "Vd,Vt,s", MATCH_VSBCVX, MASK_VSBCVX, match_opcode, 0 },
{"vsbc.vi",    0, INSN_CLASS_V,  "Vd,Vt,Vi", MATCH_VSBCVI, MASK_VSBCVI, match_opcode, 0 },
...
{"vnsrl.vv",   0, INSN_CLASS_V,  "Vd,Vt,VsVm", MATCH_VNSRLVV, MASK_VNSRLVV, match_opcode, 0 },
{"vnsrl.vx",   0, INSN_CLASS_V,  "Vd,Vt,sVm", MATCH_VNSRLVX, MASK_VNSRLVX, match_opcode, 0 },
{"vnsrl.vi",   0, INSN_CLASS_V,  "Vd,Vt,VjVm", MATCH_VNSRLVI, MASK_VNSRLVI, match_opcode, 0 },
{"vnsra.vv",   0, INSN_CLASS_V,  "Vd,Vt,VsVm", MATCH_VNSRAVV, MASK_VNSRAVV, match_opcode, 0 },
{"vnsra.vx",   0, INSN_CLASS_V,  "Vd,Vt,sVm", MATCH_VNSRAVX, MASK_VNSRAVX, match_opcode, 0 },
{"vnsra.vi",   0, INSN_CLASS_V,  "Vd,Vt,VjVm", MATCH_VNSRAVI, MASK_VNSRAVI, match_opcode, 0 },

{"vseq.vv",    0, INSN_CLASS_V,  "Vd,Vt,VsVm", MATCH_VSEQVV, MASK_VSEQVV, match_opcode, 0 },
{"vseq.vx",    0, INSN_CLASS_V,  "Vd,Vt,sVm", MATCH_VSEQVX, MASK_VSEQVX, match_opcode, 0 },
{"vseq.vi",    0, INSN_CLASS_V,  "Vd,Vt,ViVm", MATCH_VSEQVI, MASK_VSEQVI, match_opcode, 0 },
{"vsne.vv",    0, INSN_CLASS_V,  "Vd,Vt,VsVm", MATCH_VSNEVV, MASK_VSNEVV, match_opcode, 0 },
{"vsne.vx",    0, INSN_CLASS_V,  "Vd,Vt,sVm", MATCH_VSNEVX, MASK_VSNEVX, match_opcode, 0 },
{"vsne.vi",    0, INSN_CLASS_V,  "Vd,Vt,ViVm", MATCH_VSNEVI, MASK_VSNEVI, match_opcode, 0 },
{"vsltu.vv",   0, INSN_CLASS_V,  "Vd,Vt,VsVm", MATCH_VSLTUVV, MASK_VSLTUVV, match_opcode, 0 },
{"vsltu.vx",   0, INSN_CLASS_V,  "Vd,Vt,sVm", MATCH_VSLTUVX, MASK_VSLTUVX, match_opcode, 0 },
{"vslt.vv",    0, INSN_CLASS_V,  "Vd,Vt,VsVm", MATCH_VSLTVV, MASK_VSLTVV, match_opcode, 0 },
{"vslt.vx",    0, INSN_CLASS_V,  "Vd,Vt,sVm", MATCH_VSLTVX, MASK_VSLTVX, match_opcode, 0 },
{"vsleu.vv",   0, INSN_CLASS_V,  "Vd,Vt,VsVm", MATCH_VSLEUVV, MASK_VSLEUVV, match_opcode, 0 },
{"vsleu.vx",   0, INSN_CLASS_V,  "Vd,Vt,sVm", MATCH_VSLEUVX, MASK_VSLEUVX, match_opcode, 0 },
{"vsleu.vi",   0, INSN_CLASS_V,  "Vd,Vt,ViVm", MATCH_VSLEUVI, MASK_VSLEUVI, match_opcode, 0 },
{"vsle.vv",    0, INSN_CLASS_V,  "Vd,Vt,VsVm", MATCH_VSLEVV, MASK_VSLEVV, match_opcode, 0 },
{"vsle.vx",    0, INSN_CLASS_V,  "Vd,Vt,sVm", MATCH_VSLEVX, MASK_VSLEVX, match_opcode, 0 },
{"vsle.vi",    0, INSN_CLASS_V,  "Vd,Vt,ViVm", MATCH_VSLEVI, MASK_VSLEVI, match_opcode, 0 },
{"vsgtu.vx",   0, INSN_CLASS_V,  "Vd,Vt,sVm", MATCH_VSGTUVX, MASK_VSGTUVX, match_opcode, 0 },
{"vsgtu.vi",   0, INSN_CLASS_V,  "Vd,Vt,ViVm", MATCH_VSGTUVI, MASK_VSGTUVI, match_opcode, 0 },
{"vsgt.vx",    0, INSN_CLASS_V,  "Vd,Vt,sVm", MATCH_VSGTVX, MASK_VSGTVX, match_opcode, 0 },
{"vsgt.vi",    0, INSN_CLASS_V,  "Vd,Vt,ViVm", MATCH_VSGTVI, MASK_VSGTVI, match_opcode, 0 },

/* These aliases are for assembly but not disassembly.  */
{"vsgt.vv",    0, INSN_CLASS_V,  "Vd,Vs,VtVm", MATCH_VSLTVV, MASK_VSLTVV, match_opcode, INSN_ALIAS },
{"vsgtu.vv",   0, INSN_CLASS_V,  "Vd,Vs,VtVm", MATCH_VSLTUVV, MASK_VSLTUVV, match_opcode, INSN_ALIAS },
{"vsgte.vv",   0, INSN_CLASS_V,  "Vd,Vs,VtVm", MATCH_VSLEVV, MASK_VSLEVV, match_opcode, INSN_ALIAS },
{"vsgteu.vv",  0, INSN_CLASS_V,  "Vd,Vs,VtVm", MATCH_VSLEUVV, MASK_VSLEUVV, match_opcode, INSN_ALIAS },
{"vslt.vi",    0, INSN_CLASS_V,  "Vd,Vt,VkVm", MATCH_VSLEVI, MASK_VSLEVI, match_opcode, INSN_ALIAS },
{"vsltu.vi",   0, INSN_CLASS_V,  "Vd,Vt,VkVm", MATCH_VSLEUVI, MASK_VSLEUVI, match_opcode, INSN_ALIAS },
{"vsgte.vi",    0, INSN_CLASS_V,  "Vd,Vt,VkVm", MATCH_VSGTVI, MASK_VSGTVI, match_opcode, INSN_ALIAS },
{"vsgteu.vi",   0, INSN_CLASS_V,  "Vd,Vt,VkVm", MATCH_VSGTUVI, MASK_VSGTUVI, match_opcode, INSN_ALIAS },

{"vsgte.vx",    0, INSN_CLASS_V, "Vd,Vt,sVm", 0, (int) M_VSGTE, match_never, INSN_MACRO },
{"vsgte.vx",    0, INSN_CLASS_V, "Vd,Vt,s,VM,VT", 0, (int) M_VSGTE, match_never, INSN_MACRO },
{"vsgteu.vx",   0, INSN_CLASS_V, "Vd,Vt,sVm", 0, (int) M_VSGTEU, match_never, INSN_MACRO },
{"vsgteu.vx",   0, INSN_CLASS_V, "Vd,Vt,s,VM,VT", 0, (int) M_VSGTEU, match_never, INSN_MACRO },
...
{"vmacc.vv",   0, INSN_CLASS_V,  "Vd,Vt,VsVm", MATCH_VMACCVV, MASK_VMACCVV, match_opcode, 0},
{"vmacc.vx",   0, INSN_CLASS_V,  "Vd,Vt,sVm", MATCH_VMACCVX, MASK_VMACCVX, match_opcode, 0},
{"vmsac.vv",  0, INSN_CLASS_V,  "Vd,Vt,VsVm", MATCH_VMSACVV, MASK_VMSACVV, match_opcode, 0},
{"vmsac.vx",  0, INSN_CLASS_V,  "Vd,Vt,sVm", MATCH_VMSACVX, MASK_VMSACVX, match_opcode, 0},
{"vmadd.vv",   0, INSN_CLASS_V,  "Vd,Vt,VsVm", MATCH_VMADDVV, MASK_VMADDVV, match_opcode, 0},
{"vmadd.vx",   0, INSN_CLASS_V,  "Vd,Vt,sVm", MATCH_VMADDVX, MASK_VMADDVX, match_opcode, 0},
{"vmsub.vv",  0, INSN_CLASS_V,  "Vd,Vt,VsVm", MATCH_VMSUBVV, MASK_VMSUBVV, match_opcode, 0},
{"vmsub.vx",  0, INSN_CLASS_V,  "Vd,Vt,sVm", MATCH_VMSUBVX, MASK_VMSUBVX, match_opcode, 0},

{"vwmaccu.vv",   0, INSN_CLASS_V,  "Vd,Vt,VsVm", MATCH_VWMACCUVV, MASK_VWMACCUVV, match_opcode, 0},
{"vwmaccu.vx",   0, INSN_CLASS_V,  "Vd,Vt,sVm", MATCH_VWMACCUVX, MASK_VWMACCUVX, match_opcode, 0},
{"vwmacc.vv",   0, INSN_CLASS_V,  "Vd,Vt,VsVm", MATCH_VWMACCVV, MASK_VWMACCVV, match_opcode, 0},
{"vwmacc.vx",   0, INSN_CLASS_V,  "Vd,Vt,sVm", MATCH_VWMACCVX, MASK_VWMACCVX, match_opcode, 0},
{"vwmsacu.vv",   0, INSN_CLASS_V,  "Vd,Vt,VsVm", MATCH_VWMSACUVV, MASK_VWMSACUVV, match_opcode, 0},
{"vwmsacu.vx",   0, INSN_CLASS_V,  "Vd,Vt,sVm", MATCH_VWMSACUVX, MASK_VWMSACUVX, match_opcode, 0},
{"vwmsac.vv",   0, INSN_CLASS_V,  "Vd,Vt,VsVm", MATCH_VWMSACVV, MASK_VWMSACVV, match_opcode, 0},
{"vwmsac.vx",   0, INSN_CLASS_V,  "Vd,Vt,sVm", MATCH_VWMSACVX, MASK_VWMSACVX, match_opcode, 0},
...
{"vmv.v.v",    0, INSN_CLASS_V,  "Vd,Vu", MATCH_VMVVV, MASK_VMVVV, match_vs1_eq_vs2, INSN_ALIAS },
{"vmv.v.x",    0, INSN_CLASS_V,  "Vd,s", MATCH_VMVVX, MASK_VMVVX, match_opcode, INSN_ALIAS },
{"vmv.v.i",    0, INSN_CLASS_V,  "Vd,Vi", MATCH_VMVVI, MASK_VMVVI, match_opcode, INSN_ALIAS },

{"vmerge.vv",  0, INSN_CLASS_V,  "Vd,Vt,VsVm", MATCH_VMERGEVV, MASK_VMERGEVV, match_opcode, 0 },
{"vmerge.vx",  0, INSN_CLASS_V,  "Vd,Vt,sVm", MATCH_VMERGEVX, MASK_VMERGEVX, match_opcode, 0 },
{"vmerge.vi",  0, INSN_CLASS_V,  "Vd,Vt,ViVm", MATCH_VMERGEVI, MASK_VMERGEVI, match_opcode, 0 },
...
{"vaadd.vi",   0, INSN_CLASS_V,  "Vd,Vt,ViVm", MATCH_VAADDVI, MASK_VAADDVI, match_opcode, 0 },
...
{"vwsmaccu.vv", 0, INSN_CLASS_V,  "Vd,Vt,VsVm", MATCH_VWSMACCUVV, MASK_VWSMACCUVV, match_opcode, 0 },
{"vwsmaccu.vx", 0, INSN_CLASS_V,  "Vd,Vt,sVm", MATCH_VWSMACCUVX, MASK_VWSMACCUVX, match_opcode, 0 },
{"vwsmacc.vv",  0, INSN_CLASS_V,  "Vd,Vt,VsVm", MATCH_VWSMACCVV, MASK_VWSMACCVV, match_opcode, 0 },
{"vwsmacc.vx",  0, INSN_CLASS_V,  "Vd,Vt,sVm", MATCH_VWSMACCVX, MASK_VWSMACCVX, match_opcode, 0 },
{"vwsmsacu.vv", 0, INSN_CLASS_V,  "Vd,Vt,VsVm", MATCH_VWSMSACUVV, MASK_VWSMSACUVV, match_opcode, 0 },
{"vwsmsacu.vx", 0, INSN_CLASS_V,  "Vd,Vt,sVm", MATCH_VWSMSACUVX, MASK_VWSMSACUVX, match_opcode, 0 },
{"vwsmsac.vv",  0, INSN_CLASS_V,  "Vd,Vt,VsVm", MATCH_VWSMSACVV, MASK_VWSMSACVV, match_opcode, 0 },
{"vwsmsac.vx",  0, INSN_CLASS_V,  "Vd,Vt,sVm", MATCH_VWSMSACVX, MASK_VWSMSACVX, match_opcode, 0 },
...
{"vnclipu.vv",   0, INSN_CLASS_V,  "Vd,Vt,VsVm", MATCH_VNCLIPUVV, MASK_VNCLIPUVV, match_opcode, 0 },
{"vnclipu.vx",   0, INSN_CLASS_V,  "Vd,Vt,sVm", MATCH_VNCLIPUVX, MASK_VNCLIPUVX, match_opcode, 0 },
{"vnclipu.vi",   0, INSN_CLASS_V,  "Vd,Vt,ViVm", MATCH_VNCLIPUVI, MASK_VNCLIPUVI, match_opcode, 0 },
{"vnclip.vv",   0, INSN_CLASS_V,  "Vd,Vt,VsVm", MATCH_VNCLIPVV, MASK_VNCLIPVV, match_opcode, 0 },
{"vnclip.vx",   0, INSN_CLASS_V,  "Vd,Vt,sVm", MATCH_VNCLIPVX, MASK_VNCLIPVX, match_opcode, 0 },
{"vnclip.vi",   0, INSN_CLASS_V,  "Vd,Vt,ViVm", MATCH_VNCLIPVI, MASK_VNCLIPVI, match_opcode, 0 },
...
{"vfmadd.vv",  0, INSN_CLASS_V_AND_F, "Vd,Vt,VsVm", MATCH_VFMADDVV, MASK_VFMADDVV, match_opcode, 0},
{"vfmadd.vf",  0, INSN_CLASS_V_AND_F, "Vd,Vt,SVm", MATCH_VFMADDVF, MASK_VFMADDVF, match_opcode, 0},
{"vfnmadd.vv", 0, INSN_CLASS_V_AND_F, "Vd,Vt,VsVm", MATCH_VFNMADDVV, MASK_VFNMADDVV, match_opcode, 0},
{"vfnmadd.vf", 0, INSN_CLASS_V_AND_F, "Vd,Vt,SVm", MATCH_VFNMADDVF, MASK_VFNMADDVF, match_opcode, 0},
{"vfmsub.vv",  0, INSN_CLASS_V_AND_F, "Vd,Vt,VsVm", MATCH_VFMSUBVV, MASK_VFMSUBVV, match_opcode, 0},
{"vfmsub.vf",  0, INSN_CLASS_V_AND_F, "Vd,Vt,SVm", MATCH_VFMSUBVF, MASK_VFMSUBVF, match_opcode, 0},
{"vfnmsub.vv", 0, INSN_CLASS_V_AND_F, "Vd,Vt,VsVm", MATCH_VFNMSUBVV, MASK_VFNMSUBVV, match_opcode, 0},
{"vfnmsub.vf", 0, INSN_CLASS_V_AND_F, "Vd,Vt,SVm", MATCH_VFNMSUBVF, MASK_VFNMSUBVF, match_opcode, 0},
{"vfmacc.vv",  0, INSN_CLASS_V_AND_F, "Vd,Vt,VsVm", MATCH_VFMACCVV, MASK_VFMACCVV, match_opcode, 0},
{"vfmacc.vf",  0, INSN_CLASS_V_AND_F, "Vd,Vt,SVm", MATCH_VFMACCVF, MASK_VFMACCVF, match_opcode, 0},
{"vfnmacc.vv", 0, INSN_CLASS_V_AND_F, "Vd,Vt,VsVm", MATCH_VFNMACCVV, MASK_VFNMACCVV, match_opcode, 0},
{"vfnmacc.vf", 0, INSN_CLASS_V_AND_F, "Vd,Vt,SVm", MATCH_VFNMACCVF, MASK_VFNMACCVF, match_opcode, 0},
{"vfmsac.vv",  0, INSN_CLASS_V_AND_F, "Vd,Vt,VsVm", MATCH_VFMSACVV, MASK_VFMSACVV, match_opcode, 0},
{"vfmsac.vf",  0, INSN_CLASS_V_AND_F, "Vd,Vt,SVm", MATCH_VFMSACVF, MASK_VFMSACVF, match_opcode, 0},
{"vfnmsac.vv", 0, INSN_CLASS_V_AND_F, "Vd,Vt,VsVm", MATCH_VFNMSACVV, MASK_VFNMSACVV, match_opcode, 0},
{"vfnmsac.vf", 0, INSN_CLASS_V_AND_F, "Vd,Vt,SVm", MATCH_VFNMSACVF, MASK_VFNMSACVF, match_opcode, 0},

{"vfwmacc.vv",  0, INSN_CLASS_V_AND_F, "Vd,Vt,VsVm", MATCH_VFWMACCVV, MASK_VFWMACCVV, match_opcode, 0},
{"vfwmacc.vf",  0, INSN_CLASS_V_AND_F, "Vd,Vt,SVm", MATCH_VFWMACCVF, MASK_VFWMACCVF, match_opcode, 0},
{"vfwnmacc.vv", 0, INSN_CLASS_V_AND_F, "Vd,Vt,VsVm", MATCH_VFWNMACCVV, MASK_VFWNMACCVV, match_opcode, 0},
{"vfwnmacc.vf", 0, INSN_CLASS_V_AND_F, "Vd,Vt,SVm", MATCH_VFWNMACCVF, MASK_VFWNMACCVF, match_opcode, 0},
{"vfwmsac.vv",  0, INSN_CLASS_V_AND_F, "Vd,Vt,VsVm", MATCH_VFWMSACVV, MASK_VFWMSACVV, match_opcode, 0},
{"vfwmsac.vf",  0, INSN_CLASS_V_AND_F, "Vd,Vt,SVm", MATCH_VFWMSACVF, MASK_VFWMSACVF, match_opcode, 0},
{"vfwnmsac.vv", 0, INSN_CLASS_V_AND_F, "Vd,Vt,VsVm", MATCH_VFWNMSACVV, MASK_VFWNMSACVV, match_opcode, 0},
{"vfwnmsac.vf", 0, INSN_CLASS_V_AND_F, "Vd,Vt,SVm", MATCH_VFWNMSACVF, MASK_VFWNMSACVF, match_opcode, 0},
...
{"vfeq.vv",    0, INSN_CLASS_V_AND_F, "Vd,Vt,VsVm", MATCH_VFEQVV, MASK_VFEQVV, match_opcode, 0},
{"vfeq.vf",    0, INSN_CLASS_V_AND_F, "Vd,Vt,SVm", MATCH_VFEQVF, MASK_VFEQVF, match_opcode, 0},
{"vfne.vv",    0, INSN_CLASS_V_AND_F, "Vd,Vt,VsVm", MATCH_VFNEVV, MASK_VFNEVV, match_opcode, 0},
{"vfne.vf",    0, INSN_CLASS_V_AND_F, "Vd,Vt,SVm", MATCH_VFNEVF, MASK_VFNEVF, match_opcode, 0},
{"vflt.vv",    0, INSN_CLASS_V_AND_F, "Vd,Vt,VsVm", MATCH_VFLTVV, MASK_VFLTVV, match_opcode, 0},
{"vflt.vf",    0, INSN_CLASS_V_AND_F, "Vd,Vt,SVm", MATCH_VFLTVF, MASK_VFLTVF, match_opcode, 0},
{"vflte.vv",   0, INSN_CLASS_V_AND_F, "Vd,Vt,VsVm", MATCH_VFLTEVV, MASK_VFLTEVV, match_opcode, 0},
{"vflte.vf",   0, INSN_CLASS_V_AND_F, "Vd,Vt,SVm", MATCH_VFLTEVF, MASK_VFLTEVF, match_opcode, 0},
{"vfgt.vf",    0, INSN_CLASS_V_AND_F, "Vd,Vt,SVm", MATCH_VFGTVF, MASK_VFGTVF, match_opcode, 0},
{"vfgte.vf",   0, INSN_CLASS_V_AND_F, "Vd,Vt,SVm", MATCH_VFGTEVF, MASK_VFGTEVF, match_opcode, 0},

/* These aliases are for assembly but not disassembly.  */
{"vfgt.vv",    0, INSN_CLASS_V_AND_F, "Vd,Vs,VtVm", MATCH_VFLTVV, MASK_VFLTVV, match_opcode, INSN_ALIAS},
{"vfgte.vv",   0, INSN_CLASS_V_AND_F, "Vd,Vs,VtVm", MATCH_VFLTEVV, MASK_VFLTEVV, match_opcode, INSN_ALIAS},

{"vford.vv",   0, INSN_CLASS_V_AND_F, "Vd,Vt,VsVm", MATCH_VFORDVV, MASK_VFORDVV, match_opcode, 0},
{"vford.vf",   0, INSN_CLASS_V_AND_F, "Vd,Vt,SVm", MATCH_VFORDVF, MASK_VFORDVF, match_opcode, 0},

{"vfclass.v",  0, INSN_CLASS_V_AND_F, "Vd,VtVm", MATCH_VFCLASSV, MASK_VFCLASSV, match_opcode, 0},

{"vmv.v.f",    0, INSN_CLASS_V_AND_F, "Vd,S", MATCH_VMVVF, MASK_VMVVF, match_opcode, INSN_ALIAS},

{"vfmerge.vf", 0, INSN_CLASS_V_AND_F, "Vd,Vt,SVm", MATCH_VFMERGEVF, MASK_VFMERGEVF, match_opcode, 0},
...
{"vfncvt.xu.f.v",0,INSN_CLASS_V_AND_F, "Vd,VtVm", MATCH_VFNCVTXUFV, MASK_VFNCVTXUFV, match_opcode, 0},
{"vfncvt.x.f.v",0, INSN_CLASS_V_AND_F, "Vd,VtVm", MATCH_VFNCVTXFV, MASK_VFNCVTXFV, match_opcode, 0},
{"vfncvt.f.xu.v",0,INSN_CLASS_V_AND_F, "Vd,VtVm", MATCH_VFNCVTFXUV, MASK_VFNCVTFXUV, match_opcode, 0},
{"vfncvt.f.x.v",0, INSN_CLASS_V_AND_F, "Vd,VtVm", MATCH_VFNCVTFXV, MASK_VFNCVTFXV, match_opcode, 0},
{"vfncvt.f.f.v",0, INSN_CLASS_V_AND_F, "Vd,VtVm", MATCH_VFNCVTFFV, MASK_VFNCVTFFV, match_opcode, 0},
...
{"vmpopc.m",   0, INSN_CLASS_V, "d,VtVm", MATCH_VMPOPCM, MASK_VMPOPCM, match_opcode, 0},
{"vmfirst.m",  0, INSN_CLASS_V, "d,VtVm", MATCH_VMFIRSTM, MASK_VMFIRSTM, match_opcode, 0},
...
{"vmiota.m",   0, INSN_CLASS_V, "Vd,VtVm", MATCH_VMIOTAM, MASK_VMIOTAM, match_opcode, 0},
{"vid.v",      0, INSN_CLASS_V, "VdVm", MATCH_VIDV, MASK_VIDV, match_opcode, 0},

{"vmv.x.s",    0, INSN_CLASS_V, "d,Vt", MATCH_VMVXS, MASK_VMVXS, match_opcode, INSN_ALIAS},
...
{"vcompress.vm",0, INSN_CLASS_V, "Vd,Vt,Vs", MATCH_VCOMPRESSV, MASK_VCOMPRESSV, match_opcode, 0},
