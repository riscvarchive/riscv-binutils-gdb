...
{"vadd",      "V",   "Vd,Vs,Vt",  MATCH_VADD | MASK_VMASK, MASK_VADD | MASK_VMASK, match_opcode, 0 },
{"vadd",      "V",   "Vd,Vs,Vt,Vm",  MATCH_VADD, MASK_VADD, match_opcode, 0 },
{"vsub",      "V",   "Vd,Vs,Vt",  MATCH_VSUB | MASK_VMASK, MASK_VSUB | MASK_VMASK, match_opcode, 0 },
{"vsub",      "V",   "Vd,Vs,Vt,Vm",  MATCH_VSUB, MASK_VSUB, match_opcode, 0 },
{"vsl",       "V",   "Vd,Vs,Vt",  MATCH_VSL | MASK_VMASK, MASK_VSL | MASK_VMASK, match_opcode, 0 },
{"vsl",       "V",   "Vd,Vs,Vt,Vm",  MATCH_VSL, MASK_VSL, match_opcode, 0 },
{"vsr",       "V",   "Vd,Vs,Vt",  MATCH_VSR | MASK_VMASK, MASK_VSR | MASK_VMASK, match_opcode, 0 },
{"vsr",       "V",   "Vd,Vs,Vt,Vm",  MATCH_VSR, MASK_VSR, match_opcode, 0 },
{"vand",      "V",   "Vd,Vs,Vt",  MATCH_VAND | MASK_VMASK, MASK_VAND | MASK_VMASK, match_opcode, 0 },
{"vand",      "V",   "Vd,Vs,Vt,Vm",  MATCH_VAND, MASK_VAND, match_opcode, 0 },
{"vor",       "V",   "Vd,Vs,Vt",  MATCH_VOR | MASK_VMASK, MASK_VOR | MASK_VMASK, match_opcode, 0 },
{"vor",       "V",   "Vd,Vs,Vt,Vm",  MATCH_VOR, MASK_VOR, match_opcode, 0 },
{"vxor",      "V",   "Vd,Vs,Vt",  MATCH_VXOR | MASK_VMASK, MASK_VXOR | MASK_VMASK, match_opcode, 0 },
{"vxor",      "V",   "Vd,Vs,Vt,Vm",  MATCH_VXOR, MASK_VXOR, match_opcode, 0 },
{"vseq",      "V",   "Vd,Vs,Vt",  MATCH_VSEQ | MASK_VMASK, MASK_VSEQ | MASK_VMASK, match_opcode, 0 },
{"vseq",      "V",   "Vd,Vs,Vt,Vm",  MATCH_VSEQ, MASK_VSEQ, match_opcode, 0 },
{"vsne",      "V",   "Vd,Vs,Vt",  MATCH_VSNE | MASK_VMASK, MASK_VSNE | MASK_VMASK, match_opcode, 0 },
{"vsne",      "V",   "Vd,Vs,Vt,Vm",  MATCH_VSNE, MASK_VSNE, match_opcode, 0 },
{"vslt",      "V",   "Vd,Vs,Vt",  MATCH_VSLT | MASK_VMASK, MASK_VSLT | MASK_VMASK, match_opcode, 0 },
{"vslt",      "V",   "Vd,Vs,Vt,Vm",  MATCH_VSLT, MASK_VSLT, match_opcode, 0 },
{"vsge",      "V",   "Vd,Vs,Vt",  MATCH_VSGE | MASK_VMASK, MASK_VSGE | MASK_VMASK, match_opcode, 0 },
{"vsge",      "V",   "Vd,Vs,Vt,Vm",  MATCH_VSGE, MASK_VSGE, match_opcode, 0 },
{"vclip",     "V",   "Vd,Vs,t",  MATCH_VCLIP | MASK_VMASK, MASK_VCLIP | MASK_VMASK, match_opcode, 0 },
{"vclip",     "V",   "Vd,Vs,t,Vm",  MATCH_VCLIP, MASK_VCLIP, match_opcode, 0 },
{"vcvt",      "V",   "Vd,Vs,t",  MATCH_VCVT | MASK_VMASK, MASK_VCVT | MASK_VMASK, match_opcode, 0 },
{"vcvt",      "V",   "Vd,Vs,t,Vm",  MATCH_VCVT, MASK_VCVT, match_opcode, 0 },
{"vmpop",     "V",   "Vd,Vs",  MATCH_VMPOP | MASK_VMASK, MASK_VMPOP | MASK_VMASK, match_opcode, 0 },
{"vmpop",     "V",   "Vd,Vs,Vm",  MATCH_VMPOP, MASK_VMPOP, match_opcode, 0 },
{"vmfirst",   "V",   "Vd,Vs",  MATCH_VMFIRST | MASK_VMASK, MASK_VMFIRST | MASK_VMASK, match_opcode, 0 },
{"vmfirst",   "V",   "Vd,Vs,Vm",  MATCH_VMFIRST, MASK_VMFIRST, match_opcode, 0 },
{"vextract",  "V",   "d,Vs,t",  MATCH_VEXTRACT | MASK_VMASK, MASK_VEXTRACT | MASK_VMASK, match_opcode, 0 },
{"vextract",  "V",   "d,Vs,t,Vm",  MATCH_VEXTRACT, MASK_VEXTRACT, match_opcode, 0 },
{"vinsert",   "V",   "Vd,s,t",  MATCH_VINSERT | MASK_VMASK, MASK_VINSERT | MASK_VMASK, match_opcode, 0 },
{"vinsert",   "V",   "Vd,s,t,Vm",  MATCH_VINSERT, MASK_VINSERT, match_opcode, 0 },
{"vmerge",    "V",   "Vd,Vs,Vt",  MATCH_VMERGE | MASK_VMASK, MASK_VMERGE | MASK_VMASK, match_opcode, 0 },
{"vmerge",    "V",   "Vd,Vs,Vt,Vm",  MATCH_VMERGE, MASK_VMERGE, match_opcode, 0 },
{"vselect",   "V",   "Vd,Vs,Vt",  MATCH_VSELECT | MASK_VMASK, MASK_VSELECT | MASK_VMASK, match_opcode, 0 },
{"vselect",   "V",   "Vd,Vs,Vt,Vm",  MATCH_VSELECT, MASK_VSELECT, match_opcode, 0 },
{"vslide",    "V",   "Vd,Vs,t",  MATCH_VSLIDE | MASK_VMASK, MASK_VSLIDE | MASK_VMASK, match_opcode, 0 },
{"vslide",    "V",   "Vd,Vs,t,Vm",  MATCH_VSLIDE, MASK_VSLIDE, match_opcode, 0 },
{"vdiv",      "V",   "Vd,Vs,Vt",  MATCH_VDIV | MASK_VMASK, MASK_VDIV | MASK_VMASK, match_opcode, 0 },
{"vdiv",      "V",   "Vd,Vs,Vt,Vm",  MATCH_VDIV, MASK_VDIV, match_opcode, 0 },
{"vrem",      "V",   "Vd,Vs,Vt",  MATCH_VREM | MASK_VMASK, MASK_VREM | MASK_VMASK, match_opcode, 0 },
{"vrem",      "V",   "Vd,Vs,Vt,Vm",  MATCH_VREM, MASK_VREM, match_opcode, 0 },
{"vmul",      "V",   "Vd,Vs,Vt",  MATCH_VMUL | MASK_VMASK, MASK_VMUL | MASK_VMASK, match_opcode, 0 },
{"vmul",      "V",   "Vd,Vs,Vt,Vm",  MATCH_VMUL, MASK_VMUL, match_opcode, 0 },
{"vmulh",     "V",   "Vd,Vs,Vt",  MATCH_VMULH | MASK_VMASK, MASK_VMULH | MASK_VMASK, match_opcode, 0 },
{"vmulh",     "V",   "Vd,Vs,Vt,Vm",  MATCH_VMULH, MASK_VMULH, match_opcode, 0 },
{"vmin",      "V",   "Vd,Vs,Vt",  MATCH_VMIN | MASK_VMASK, MASK_VMIN | MASK_VMASK, match_opcode, 0 },
{"vmin",      "V",   "Vd,Vs,Vt,Vm",  MATCH_VMIN, MASK_VMIN, match_opcode, 0 },
{"vmax",      "V",   "Vd,Vs,Vt",  MATCH_VMAX | MASK_VMASK, MASK_VMAX | MASK_VMASK, match_opcode, 0 },
{"vmax",      "V",   "Vd,Vs,Vt,Vm",  MATCH_VMAX, MASK_VMAX, match_opcode, 0 },
{"vsgnj",     "V",   "Vd,Vs,Vt",  MATCH_VSGNJ | MASK_VMASK, MASK_VSGNJ | MASK_VMASK, match_opcode, 0 },
{"vsgnj",     "V",   "Vd,Vs,Vt,Vm",  MATCH_VSGNJ, MASK_VSGNJ, match_opcode, 0 },
{"vsgnjn",    "V",   "Vd,Vs,Vt",  MATCH_VSGNJN | MASK_VMASK, MASK_VSGNJN | MASK_VMASK, match_opcode, 0 },
{"vsgnjn",    "V",   "Vd,Vs,Vt,Vm",  MATCH_VSGNJN, MASK_VSGNJN, match_opcode, 0 },
{"vsgnjx",    "V",   "Vd,Vs,Vt",  MATCH_VSGNJX | MASK_VMASK, MASK_VSGNJX | MASK_VMASK, match_opcode, 0 },
{"vsgnjx",    "V",   "Vd,Vs,Vt,Vm",  MATCH_VSGNJX, MASK_VSGNJX, match_opcode, 0 },
{"vsqrt",     "V",   "Vd,Vs",  MATCH_VSQRT | MASK_VMASK, MASK_VSQRT | MASK_VMASK, match_opcode, 0 },
{"vsqrt",     "V",   "Vd,Vs,Vm",  MATCH_VSQRT, MASK_VSQRT, match_opcode, 0 },
{"vclass",    "V",   "Vd,Vs",  MATCH_VCLASS | MASK_VMASK, MASK_VCLASS | MASK_VMASK, match_opcode, 0 },
{"vclass",    "V",   "Vd,Vs,Vm",  MATCH_VCLASS, MASK_VCLASS, match_opcode, 0 },
{"vpopc",     "V",   "Vd,Vs",  MATCH_VPOPC | MASK_VMASK, MASK_VPOPC | MASK_VMASK, match_opcode, 0 },
{"vpopc",     "V",   "Vd,Vs,Vm",  MATCH_VPOPC, MASK_VPOPC, match_opcode, 0 },
{"vaddi",     "V",   "Vd,Vs,Vi",  MATCH_VADDI | MASK_VMASK, MASK_VADDI | MASK_VMASK, match_opcode, 0 },
{"vaddi",     "V",   "Vd,Vs,Vi,Vm",  MATCH_VADDI, MASK_VADDI, match_opcode, 0 },
{"vsli",      "V",   "Vd,Vs,Vi",  MATCH_VSLI | MASK_VMASK, MASK_VSLI | MASK_VMASK, match_opcode, 0 },
{"vsli",      "V",   "Vd,Vs,Vi,Vm",  MATCH_VSLI, MASK_VSLI, match_opcode, 0 },
{"vsri",      "V",   "Vd,Vs,Vi",  MATCH_VSRI | MASK_VMASK, MASK_VSRI | MASK_VMASK, match_opcode, 0 },
{"vsri",      "V",   "Vd,Vs,Vi,Vm",  MATCH_VSRI, MASK_VSRI, match_opcode, 0 },
{"vandi",     "V",   "Vd,Vs,Vi",  MATCH_VANDI | MASK_VMASK, MASK_VANDI | MASK_VMASK, match_opcode, 0 },
{"vandi",     "V",   "Vd,Vs,Vi,Vm",  MATCH_VANDI, MASK_VANDI, match_opcode, 0 },
{"vori",      "V",   "Vd,Vs,Vi",  MATCH_VORI | MASK_VMASK, MASK_VORI | MASK_VMASK, match_opcode, 0 },
{"vori",      "V",   "Vd,Vs,Vi,Vm",  MATCH_VORI, MASK_VORI, match_opcode, 0 },
{"vxori",     "V",   "Vd,Vs,Vi",  MATCH_VXORI | MASK_VMASK, MASK_VXORI | MASK_VMASK, match_opcode, 0 },
{"vxori",     "V",   "Vd,Vs,Vi,Vm",  MATCH_VXORI, MASK_VXORI, match_opcode, 0 },
{"vclipi",    "V",   "Vd,Vs,Vi",  MATCH_VCLIPI | MASK_VMASK, MASK_VCLIPI | MASK_VMASK, match_opcode, 0 },
{"vclipi",    "V",   "Vd,Vs,Vi,Vm",  MATCH_VCLIPI, MASK_VCLIPI, match_opcode, 0 },
{"vmadd",     "V",   "Vd,Vs,Vt,Vu",  MATCH_VMADD | MASK_VMASK, MASK_VMADD | MASK_VMASK, match_opcode, 0 },
{"vmadd",     "V",   "Vd,Vs,Vt,Vu,Vm",  MATCH_VMADD, MASK_VMADD, match_opcode, 0 },
{"vmsub",     "V",   "Vd,Vs,Vt,Vu",  MATCH_VMSUB | MASK_VMASK, MASK_VMSUB | MASK_VMASK, match_opcode, 0 },
{"vmsub",     "V",   "Vd,Vs,Vt,Vu,Vm",  MATCH_VMSUB, MASK_VMSUB, match_opcode, 0 },
{"vnmadd",    "V",   "Vd,Vs,Vt,Vu",  MATCH_VNMADD | MASK_VMASK, MASK_VNMADD | MASK_VMASK, match_opcode, 0 },
{"vnmadd",    "V",   "Vd,Vs,Vt,Vu,Vm",  MATCH_VNMADD, MASK_VNMADD, match_opcode, 0 },
{"vnmsub",    "V",   "Vd,Vs,Vt,Vu",  MATCH_VNMSUB | MASK_VMASK, MASK_VNMSUB | MASK_VMASK, match_opcode, 0 },
{"vnmsub",    "V",   "Vd,Vs,Vt,Vu,Vm",  MATCH_VNMSUB, MASK_VNMSUB, match_opcode, 0 },
{"vld",       "V",   "Vd,Vo(s)",  MATCH_VLD | MASK_VMASK, MASK_VLD | MASK_VMASK, match_opcode, 0 },
{"vld",       "V",   "Vd,Vo(s),Vm",  MATCH_VLD, MASK_VLD, match_opcode, 0 },
{"vlds",      "V",   "Vd,Vo(s),t",  MATCH_VLDS | MASK_VMASK, MASK_VLDS | MASK_VMASK, match_opcode, 0 },
{"vlds",      "V",   "Vd,Vo(s),t,Vm",  MATCH_VLDS, MASK_VLDS, match_opcode, 0 },
{"vldx",      "V",   "Vd,Vo(s),Vt",  MATCH_VLDX | MASK_VMASK, MASK_VLDX | MASK_VMASK, match_opcode, 0 },
{"vldx",      "V",   "Vd,Vo(s),Vt,Vm",  MATCH_VLDX, MASK_VLDX, match_opcode, 0 },
{"vst",       "V",   "Vu,Vq(s)",  MATCH_VST | MASK_VMASK, MASK_VST | MASK_VMASK, match_opcode, 0 },
{"vst",       "V",   "Vu,Vq(s),Vm",  MATCH_VST, MASK_VST, match_opcode, 0 },
{"vsts",      "V",   "Vu,Vq(s),t",  MATCH_VSTS | MASK_VMASK, MASK_VSTS | MASK_VMASK, match_opcode, 0 },
{"vsts",      "V",   "Vu,Vq(s),t,Vm",  MATCH_VSTS, MASK_VSTS, match_opcode, 0 },
{"vstx",      "V",   "Vu,Vq(s),Vt",  MATCH_VSTX | MASK_VMASK, MASK_VSTX | MASK_VMASK, match_opcode, 0 },
{"vstx",      "V",   "Vu,Vq(s),Vt,Vm",  MATCH_VSTX, MASK_VSTX, match_opcode, 0 },
