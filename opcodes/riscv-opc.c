...
{"pollentropy",  0, INSN_CLASS_ZKR,     "d",  MATCH_POLLENTROPY, MASK_POLLENTROPY, match_opcode, 0 },
{"getnoise",     0, INSN_CLASS_ZKR,     "d",  MATCH_GETNOISE, MASK_GETNOISE, match_opcode, 0 },
