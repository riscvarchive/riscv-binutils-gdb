...
static uint64_t riscv_breakpoint = 0x400b3cae70166000ULL;
#define riscv_breakpoint_len 8
...
{
  *size = riscv_breakpoint_len;
  return (const gdb_byte *) &riscv_breakpoint;
}
