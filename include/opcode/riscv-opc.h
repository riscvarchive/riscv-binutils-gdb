...
/* RVV */
DECLARE_CSR(vstart, CSR_VSTART, CSR_CLASS_I)
DECLARE_CSR(vxsat, CSR_VXSAT, CSR_CLASS_I)
DECLARE_CSR(vxrm, CSR_VXRM, CSR_CLASS_I)
DECLARE_CSR(vl, CSR_VL, CSR_CLASS_I)
DECLARE_CSR(vtype, CSR_VTYPE, CSR_CLASS_I)
DECLARE_CSR(vlenb, CSR_VLENB, CSR_CLASS_I)
