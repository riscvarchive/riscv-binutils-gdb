...
enum riscv_insn_class
{
  ...
  INSN_CLASS_ZBC,
  INSN_CLASS_ZBP,
  INSN_CLASS_ZBB_OR_INSN_CLASS_ZBP,
  INSN_CLASS_ZBS,
  INSN_CLASS_ZBE,
  INSN_CLASS_ZBS_OR_INSN_CLASS_ZBE,
  INSN_CLASS_ZBF,
  INSN_CLASS_ZBM,
  INSN_CLASS_ZBP_OR_INSN_CLASS_ZBM,
  INSN_CLASS_ZBR,
  INSN_CLASS_ZBT,
  INSN_CLASS_ZBP_OR_INSN_CLASS_ZBE_OR_INSN_CLASS_ZBF,
  INSN_CLASS_ZBP_OR_INSN_CLASS_ZBE_OR_INSN_CLASS_ZBF_OR_INSN_CLASS_ZBM,
};
