...
START_RELOC_NUMBERS (elf_riscv_reloc_type)
  ...
  RELOC_NUMBER (R_RISCV_HI20_RELAX, 49)
  RELOC_NUMBER (R_RISCV_LO12_I_RELAX, 50)
  RELOC_NUMBER (R_RISCV_LO12_S_RELAX, 51)
  RELOC_NUMBER (R_RISCV_CALL_RELAX, 52)
  RELOC_NUMBER (R_RISCV_CALL_PLT_RELAX, 53)
  RELOC_NUMBER (R_RISCV_TPREL_HI20_RELAX, 54)
  RELOC_NUMBER (R_RISCV_TPREL_LO12_I_RELAX, 55)
  RELOC_NUMBER (R_RISCV_TPREL_LO12_S_RELAX, 56)
  RELOC_NUMBER (R_RISCV_TPREL_I, 57)
  RELOC_NUMBER (R_RISCV_TPREL_S, 58)
