...
START_RELOC_NUMBERS (elf_riscv_reloc_type)
  ...
  RELOC_NUMBER (R_RISCV_64_PCREL, 59)
  RELOC_NUMBER (R_RISCV_GPREL_HI20, 60)
  RELOC_NUMBER (R_RISCV_GPREL_LO12_I, 61)
  RELOC_NUMBER (R_RISCV_GPREL_LO12_S, 62)
  RELOC_NUMBER (R_RISCV_GPREL_ADD, 63)
  RELOC_NUMBER (R_RISCV_GPREL_LOAD, 64)
  RELOC_NUMBER (R_RISCV_GPREL_STORE, 65)
  RELOC_NUMBER (R_RISCV_GOT_GPREL_HI20, 66)
  RELOC_NUMBER (R_RISCV_GOT_GPREL_LO12_I, 67)
  RELOC_NUMBER (R_RISCV_GOT_GPREL_ADD, 68)
  RELOC_NUMBER (R_RISCV_GOT_GPREL_LOAD, 69)
  RELOC_NUMBER (R_RISCV_GOT_GPREL_STORE, 70)
  RELOC_NUMBER (R_RISCV_TLS_GOT_GPREL_HI20, 71)
  RELOC_NUMBER (R_RISCV_TLS_GOT_GPREL_LO12_I, 72)
  RELOC_NUMBER (R_RISCV_TLS_GD_GPREL_HI20, 73)
  RELOC_NUMBER (R_RISCV_TLS_GD_GPREL_LO12_I, 74)
